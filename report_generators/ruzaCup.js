 ...
 */
export async function generateRuzaCupReport(dispancer, childInfo, year, dateOfCompetition, dirPath) {
    try {
        ...
        const cell = worksheet.getRow(4).getCell('A');
        cell.value = `г. Руза, ${dateOfCompetition} ${year} года`;
