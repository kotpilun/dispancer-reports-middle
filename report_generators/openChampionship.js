 ...
 */
export async function generateOpenChampionshipReport(dispancer, childInfo, year, dateOfCompetition, city, give, dirPath) {
    try {
        ...
        cell.value = `на участие в Открытом турнире по плаванию, посвященного "${give}"`
